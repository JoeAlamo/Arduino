...
static AEADTest const AES128EAXTest = {
  "AES-128-EAX-encrypt-tag",
...
void performEncryptionAndTag(const struct AEADTest *test, EAX<AES128> *cipher) {
...
void setup() {
  ...
  Serial.println();
  performEncryptionAndTag(&AES128EAXTest, &AEAD);
}
