...
static AEADTest const ChaChaPolyTest = {
  "ChaChaPoly-encrypt-tag",
...
void performEncryptionAndTag(const struct AEADTest *test, ChaChaPoly *cipher) {
...
void setup() {
  ...
  Serial.println();
  performEncryptionAndTag(&ChaChaPolyTest, &AEAD);
}
